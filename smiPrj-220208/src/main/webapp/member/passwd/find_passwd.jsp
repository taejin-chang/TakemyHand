...
(function(i, s, o, g, r, a, m) {
    ...
    a.src = g;
    a.onload = function() {
        i[r].init('https://js-error-tracer-api.cafe24.com', {"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..TpNc27wB9ntNBZgnk-FzR54SqsnVvjrlgMrSba17zyc","collectWindowErrors":true,"preventDuplicateReport":true,"storageKeyPrefix":"EC_JET.MEMBER_ID_FIND"});
    };
...
<link rel="stylesheet" type="text/css" href="http://ecudemo200642.cafe24.com/ind-script/optimizer.php?filename=nc1LCoAwDIThfXHrOYLeqC3xAU2mpCno7RW8gHQ7zMdPB4RpWY2qYbcoZNzQLTPl1mgzqFOGCHR6h5n-_DmHhtL9hIaEaxB299FoiTfbGPWYCg9S1FBO5ZCi6td_AA&type=css&k=37c9481ac0212340e132f81eba4d1049fee7f18e&t=1635315871"  /><link rel="stylesheet" type="text/css" href="http://ecudemo200642.cafe24.com/ind-script/optimizer.php?filename=tdRBTkQhDAbg_Ty3noPJxMwZXLjzBFD6oAlQQsE4t5c3ToxrpTtCyVfyp2AiZzQI2xBsMhfDY-bL-Xx9uZg6XCLYYs_JiMfNo1AoxllBAyImsx8JTcbssJmdit_IP83Ks_krm-yNRz_WBPcewDlzWYx-byxGEU5H4TRICe7MqVNV0iMmLbq2OSiglXe1gYrtqJW6dUqyG70vH-0fnD_1AklaYc9DoETPArb_2b_-vEebPOaLlMj1PVKtVMLqBsDlYxrEpcJyez6awO222hW0DeIrWr8-8MSBO9flV-4zi8PedzW6qA3fG8n9c_0C&type=css&k=387af85d8b77b6a0c015b144eaa25c27ae6fa40b&t=1636193578&user=T"  />
...
<input id="returnUrl" name="returnUrl" type="hidden"  /><div class="xans-element- xans-member xans-member-findid ec-base-box typeThin "><!--
...
<legend>비밀번호 찾기</legend>
            <p class="check">
            <label for="check_method0" ><span id="ssn_lable" style="display:inline;"></span></label>
            
<input id="ccc" name="efgh" type="radio" value="1" onchange="setDisplay()" ><label for="check_method1" >이메일</label>
<input id="ddd" name="efgh" type="radio" onchange="setDisplay()" value="2"><label for="check_method2" ><span id="search_type_mobile_lable" style="display:inline;">휴대폰번호</span></label></p>
<div>
<p id="id_view" class="id"><strong id="id_lable">아이디</strong> <input id="m_userid" name="m_userid" fw-filter="" fw-label="아이디" fw-msg="" class="lostInput" placeholder="" value="" type="text"  /></p>
</div>
<div>
<p id="name_view" class="name"><strong id="name_lable">이름</strong> <input id="m_name" name="name" fw-filter="" fw-label="이름" fw-msg="" class="lostInput" placeholder="" value="" type="text"  /></p>
</div>
<div id="email_view" style="display:none;">
<p class="email"><strong>이메일로 찾기</strong> <input id="m_email" name="email" fw-filter="isEmail" fw-label="이메일" fw-msg="" class="lostInput" placeholder="" value="" type="text"  /></p>
</div>
<div id="mobile_view" style="display:none;">
<p class="mobile" ><strong>휴대폰 번호로 찾기</strong> <input id="mobile1" name="mobile1" fw-filter="isMin[3]&isMax[3]&isNumber" fw-label="휴대전화 번호" fw-msg="" class="mobile1" placeholder="" maxlength="3" value="" type="text"  /> - <input id="mobile2" name="mobile2" fw-filter="isMin[3]&isMax[4]&isNumber" fw-label="휴대전화 번호" fw-msg="" class="mobile2" placeholder="" maxlength="4" value="" type="text"  /> - <input id="mobile3" name="mobile3" fw-filter="isMin[4]&isMax[4]&isNumber" fw-label="휴대전화 번호" fw-msg="" class="mobile2" placeholder="" maxlength="4" value="" type="text"  /></p>
</div>

<p id="mobile_auth_view" class="mobileauth" style="display:none;">
    <strong>휴대폰인증으로 찾기</strong>
    <span>본인 명의의 휴대폰으로 아이디 찾기를<br/> 진행할 수 있습니다. 휴대폰 명의자의<br/> 정보로가입한 아이디 찾기가 가능합니다.</span>
    <a href="#none" class="btnNormal" onclick="findId.action('ecudemo200642' , 'kcp'); return false;"><img src="//img.echosting.cafe24.com/skin/base/common/btn_icon_mobile.gif" alt=""/> 휴대폰 인증</a>
</p>
<div class="ec-base-button gColumn">
    <button type="submit" class="btnSubmit sizeM" onclick="findPwaction()">확인</button>
</div>
</fieldset>
</div>
</div>
...
function setDisplay() {
    if($('input:radio[id=ccc]').is(':checked')){
        $('#email_view').show();
        $('#mobile_view').hide();
    }else{
        $('#email_view').hide();
...
function findPwaction() {
	...
	var m_tel=$("#mobile1").val()+'-'+$("#mobile2").val()+'-'+$("#mobile3").val();
	
	if((m_email!="") && (m_name!="") && (m_userid!="")) {
		var urlstring="find_pw_action.jsp?m_userid="+m_userid+"&m_name="+m_name+"&m_email="+m_email;
		window.open(urlstring,findPwaction,"width=500,height=500,left=600,top=250");
	} else if((m_tel!="") && (m_name!="") && (m_userid!="")) {
		var urlstring="find_pw_action.jsp?m_userid="+m_userid+"&m_name="+m_name+"&m_tel="+m_tel;
		window.open(urlstring,findPwaction,"width=500,height=500,left=600,top=250");
	}
...
<%@include file="/include/footer.jsp"%>
	...
	<!--if($("input:radio[name=check_method1]").is(":checked")==true) {-->
		<!--document.getElementById("check_method1").className = "email";-->
		<!--  	if($("input:radio[name=check_method2]").is(":checked")==true) {-->
		
		<!--document.getElementById("check_method2").className = "mobile";-->
