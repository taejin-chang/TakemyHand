...
(function(i, s, o, g, r, a, m) {
    ...
    a.src = g;
    a.onload = function() {
        i[r].init('https://js-error-tracer-api.cafe24.com', {"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..0amcaAA8EPvNBs0ku9cvwa1NogZ3P7VU3oZq6uYeGks","collectWindowErrors":true,"preventDuplicateReport":true,"storageKeyPrefix":"EC_JET.MEMBER_PW_FIND"});
    };
...
CAFE24.FRONT_JS_CONFIG_MEMBER = {"sAuthUrl":"https:\/\/i-pin.cafe24.com\/certify\/1.0\/?action=auth","bIsDisplayActivationSendButton":false};
...
<link rel="stylesheet" type="text/css" href="http://ecudemo200642.cafe24.com/ind-script/optimizer.php?filename=nc1LCoAwDIThfXHrOYLeqC3xAU2mpCno7RW8gHQ7zMdPB4RpWY2qYbcoZNzQLTPl1mgzqFOGCHR6h5n-_DmHhtL9hIaEaxB299FoiTfbGPWYCg9S1FBO5ZCi6td_AA&type=css&k=37c9481ac0212340e132f81eba4d1049fee7f18e&t=1635315871"  /><link rel="stylesheet" type="text/css" href="http://ecudemo200642.cafe24.com/ind-script/optimizer.php?filename=tdRBTkQhDAbg_Ty3noPJxHgGF-48AZQ-aAKUUHCc28sbjXGtdEco-Ur-FEzkjAZhG4JN5mJ4zHw5n5-fLqYOlwi22HMy4nHzKBSKcVbQgIjJ7EdCkzE7bGan4rdqRa7-YVYfzV_pZG88-rEmuPcBzpnLYvRrYzGKcDoKp0FKcGdOnaqSHjFp0bXNYQGtvKsNVGxHrdStU5Ld6H35aP_g_KEXSNIKex4CJXoWsP3P_vXvfbfJY75IiVzfItVKJaxuAFzep0FcKiy356MJ3G6rXUHbIL6g9esDTxy4c11-5T6zOOx9V6OL2vC9ktw_108&type=css&k=a65a8ab7ebc2b365a9998941ea0f362049e9ca56&t=1636193578&user=T"  />
...
<input id="resultURL" name="resultURL" value="" type="hidden"  /><div class="xans-element- xans-member xans-member-findpasswd ec-base-box typeThin "><!--
...
</select><span class="check gBlank5"><input id="check_method0" name="check_method" fw-filter="" fw-label="찾는방법" fw-msg="" value="1" type="radio"  /><label for="check_method0" ><span id="ssn_lable" style="display:inline;"></span></label>
...
<strong class="term" id="ssn_name">법인번호로 찾기</strong><span class="desc"> <input id="ssn" name="ssn" fw-filter="isNumber" fw-label="주민등록번호" fw-msg="" class="lostInput" maxlength="20" value="" type="password"  /> <span class="gBlank5 txtInfo">(-) 없이 숫자만 입력하세요.</span></span>
</li>
...
<strong class="term">아이핀인증으로 찾기</strong><span class="desc txtInfo">회원가입을 아이핀으로 가입하신 <br/>회원님께서는 아이핀으로 인증하세요. <a href="#none" class="btnNormal" onclick="findPasswd.action('ecudemo200642' , 'kcp'); return false;"><img src="//img.echosting.cafe24.com/skin/base/common/btn_icon_ipin.gif" alt=""/> 아이핀인증</a></span>
</li>
                <li id="mobile_auth_view" class="mobileauth" style="display:none;">
<strong class="term">휴대폰인증으로 찾기</strong><span class="desc txtInfo">본인 명의의 휴대폰으로 아이디 찾기를<br/> 진행할 수 있습니다. 휴대폰 명의자의<br/> 정보로 가입한 아이디 찾기가 가능합니다.</span>
</li>
            </ul>
<div class="ec-base-button gColumn">
                <a href="#none" class="btnSubmit sizeM" onclick="findPasswd.action('ecudemo200642' , 'kcp'); return false;">확인</a>
            </div>
        </fieldset>
</div>
</div>
