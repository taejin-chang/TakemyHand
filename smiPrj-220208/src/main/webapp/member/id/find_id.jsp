...
<div class="ec-base-button gColumn">
    <button type="submit" class="btnSubmit sizeM" onclick="findIdaction()">확인</button>
</div>
</fieldset>
</div>
</div>
...
function findIdaction() {
	...
	if((m_email!="") && (m_name!="")) {
		var urlstring="find_id_action.jsp?m_name="+m_name+"&m_email="+m_email;
		window.open(urlstring,findIdaction,"width=400,height=400,left=600,top=250");
	} else if((m_tel!="") && (m_name!="")) {
		var urlstring="find_id_action.jsp?m_name="+m_name+"&m_tel="+m_tel;
		window.open(urlstring,findIdaction,"width=400,height=400,left=600,top=250");
	}
