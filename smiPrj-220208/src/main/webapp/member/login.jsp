...
<form method="post" name="loginForm">
            <label class="id ePlaceholder" title="아이디"><input id="id" name="id" fw-filter="isFill" fw-label="아이디" fw-msg="" class="inputTypeText" placeholder="아이디를 입력해주세요" value="<%=id%>" type="text"  /></label>
...
<li><a href="<%=request.getContextPath()%>/member/id/find_id.jsp">아이디찾기</a></li>
                <li><a href="<%=request.getContextPath()%>/member/passwd/find_passwd.jsp">비밀번호찾기</a></li>
