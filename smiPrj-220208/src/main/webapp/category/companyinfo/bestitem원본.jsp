...
(function(i, s, o, g, r, a, m) {
    ...
    a.src = g;
    a.onload = function() {
        i[r].init('https://js-error-tracer-api.cafe24.com', {"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..zL6IIkiZdmuwzy9OYy6w_MYHUcXk6dDQzLS-BdxseQk","collectWindowErrors":true,"preventDuplicateReport":true,"storageKeyPrefix":"EC_JET.PRODUCT_LIST"});
    };
...
<meta property="og:url" content="http://ecudemo200642.cafe24.com/category/top/44/" />
...
<li><a href="../../../index.html">홈</a></li>
            <li class=""><a href="index.html">BEST ITEM</a></li>
...
<h2><span><strong>BEST ITEM</strong></span></h2>
...
<span>BEST</span><span class="num">01</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/bestitem/bestitem.jsp" name="anchorBoxName_42"><img src="<%=request.getContextPath()%>/web/product/medium/202110/8614d86c9cf54d8bf9d17497dc1b740d.jpg" id="eListPrdImage42_2" alt="샘플상품 07"/></a>
            ...
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/샘플상품-07/42/category/44/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;">샘플상품 07</span></a></strong>
...
<span>BEST</span><span class="num">02</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product/sample-product-06/41/category/44/display/2/index.html" name="anchorBoxName_41"><img src="<%=request.getContextPath()%>/web/product/medium/202110/3e2961b47f9f78ef9a67e1bb290aad5e.jpg" id="eListPrdImage41_2" alt="sample product 06"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-06/41/category/44/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;">sample product 06</span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
...
<span>BEST</span><span class="num">03</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product/sample-product-05/40/category/44/display/2/index.html" name="anchorBoxName_40"><img src="<%=request.getContextPath()%>/web/product/medium/202110/30a3728facb2164bb332c92f3c106846.jpg" id="eListPrdImage40_2" alt="sample product 05"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-05/40/category/44/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;">sample product 05</span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
...
<span>BEST</span><span class="num">04</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product/sample-product-04/39/category/44/display/2/index.html" name="anchorBoxName_39"><img src="<%=request.getContextPath()%>/web/product/medium/202110/3fa9de22432e687438c27d6618885ea6.jpg" id="eListPrdImage39_2" alt="sample product 04"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-04/39/category/44/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;">sample product 04</span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
...
<div class="function" id="Product_ListMenu">
            <p class="prdCount">Total : <strong>32</strong> items</p>
            <ul id="type" class="xans-element- xans-product xans-product-orderby"><li class="xans-record-"><a href="http://ecudemo200642.cafe24.com/category/top/44/?cate_no=44&sort_method=5#Product_ListMenu" >신상품</a></li>
<li class="xans-record-"><a href="<%=request.getContextPath()%>/category/top/44/?cate_no=44&sort_method=1#Product_ListMenu" >상품명</a></li>
<li class="xans-record-"><a href="<%=request.getContextPath()%>/category/top/44/?cate_no=44&sort_method=3#Product_ListMenu" >낮은가격</a></li>
<li class="xans-record-"><a href="<%=request.getContextPath()%>/category/top/44/?cate_no=44&sort_method=4#Product_ListMenu" >높은가격</a></li>
<li class="xans-record-"><a href="<%=request.getContextPath()%>/category/top/44/?cate_no=44&sort_method=2#Product_ListMenu" >제조사</a></li>
<li class="xans-record-"><a href="<%=request.getContextPath()%>/category/top/44/?cate_no=44&sort_method=7#Product_ListMenu" >사용후기</a></li>
</ul>
...
<div class="xans-element- xans-product xans-product-listnormal ec-base-product"><!--
        ...
        -->
<ul class="prdList grid4">    
<c:forEach var="photo" begin="1" end="24"  >

<li id="anchorBoxId_42" class="xans-record-">
                <div class="thumbnail">
                    <div class="prdImg">
                        <a href="<%=request.getContextPath()%>/product_detail/bestitem/bestitem.jsp" name="anchorBoxName_42"><img src="<%=request.getContextPath()%>/web/product/medium/202110/8614d86c9cf54d8bf9d17497dc1b740d.jpg" id="eListPrdImage42_1" alt="샘플상품 07"/></a>
                	    <span class="wish"> </span>
                    </div>
                </div>
                <div class="description">
                    ...
                    <span class="chk"><input type="checkbox" class="ProductCompareClass xECPCNO_42 displaynone"/></span>
                    <strong class="name"><a href="<%=request.getContextPath()%>/product/샘플상품-07/42/category/44/display/1/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;">샘플상품 07</span></a></strong>
                    <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;">72,000원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
