...
<h2><span><strong style="font-size: 25px;">서랍장</strong></span></h2>
...
<span>BEST</span><span class="num">01</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=drawerlist.get(1).getP_no() %>&p_name=<%=drawerlist.get(1).getP_name()%>&p_price=<%=drawerlist.get(1).getP_price()%>&p_imgsrc=<%=drawerlist.get(1).getP_imgsrc()%>&p_kinds=<%=drawerlist.get(1).getP_kinds()%>" name="anchorBoxName_42"><img src="<%=request.getContextPath()%>/web/images/300_organize/320_drawer/DRAWER1.jpg" id="eListPrdImage42_2" alt="샘플상품 07"/></a>
            ...
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/샘플상품-07/42/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=drawerlist.get(1).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=drawerlist.get(1).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>
...
<span>BEST</span><span class="num">02</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=drawerlist.get(3).getP_no() %>&p_name=<%=drawerlist.get(3).getP_name()%>&p_price=<%=drawerlist.get(3).getP_price()%>&p_imgsrc=<%=drawerlist.get(3).getP_imgsrc()%>&p_kinds=<%=drawerlist.get(3).getP_kinds()%>" name="anchorBoxName_41"><img src="<%=request.getContextPath()%>/web/images/300_organize/320_drawer/DRAWER3.jpg" id="eListPrdImage41_2" alt="sample product 06"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-06/41/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=drawerlist.get(3).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=drawerlist.get(3).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>
...
<span>BEST</span><span class="num">03</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=drawerlist.get(5).getP_no() %>&p_name=<%=drawerlist.get(5).getP_name()%>&p_price=<%=drawerlist.get(5).getP_price()%>&p_imgsrc=<%=drawerlist.get(5).getP_imgsrc()%>&p_kinds=<%=drawerlist.get(5).getP_kinds()%>" name="anchorBoxName_40"><img src="<%=request.getContextPath()%>/web/images/300_organize/320_drawer/DRAWER5.jpg" id="eListPrdImage40_2" alt="sample product 05"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-05/40/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=drawerlist.get(5).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=drawerlist.get(5).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>          
...
<span>BEST</span><span class="num">04</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=drawerlist.get(7).getP_no() %>&p_name=<%=drawerlist.get(7).getP_name()%>&p_price=<%=drawerlist.get(7).getP_price()%>&p_imgsrc=<%=drawerlist.get(7).getP_imgsrc()%>&p_kinds=<%=drawerlist.get(7).getP_kinds()%>" name="anchorBoxName_39"><img src="<%=request.getContextPath()%>/web/images/300_organize/320_drawer/DRAWER7.jpg" id="eListPrdImage39_2" alt=""/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-04/39/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=drawerlist.get(7).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=drawerlist.get(7).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>   
...
<div class="function" id="Product_ListMenu">
            <p class="prdCount" style="font-size: 15px;">Total : <strong style="font-size: 15px;"><%=totcount2%></strong > items</p>
...
<a href="<%=request.getContextPath()%>/category/outer/45/?page=2" class="last"><img src="//img.echosting.cafe24.com/skin/base/common/btn_page_last.gif" alt="마지막 페이지"/></a>
       ...
       <div id="gotop" style="display:run-in;">
