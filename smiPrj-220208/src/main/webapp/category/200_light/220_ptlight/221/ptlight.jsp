...
int totcount2 = PtlightDAO.getDAO().PtLightCount();
%>
...
<h2><span><strong style="font-size: 25px;">거실조명</strong></span></h2>
...
<span>BEST</span><span class="num">01</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=ptlist.get(1).getP_no()%>&p_name=<%=ptlist.get(1).getP_name()%>&p_price=<%=ptlist.get(1).getP_price()%>&p_imgsrc=<%=ptlist.get(1).getP_imgsrc()%>&p_kinds=<%=ptlist.get(1).getP_kinds()%>" name="anchorBoxName_42"><img src="<%=request.getContextPath()%>/web/images/200_light/220_ptlight/ptlight1.jpg" id="eListPrdImage42_2" alt=/></a>
            ...
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/샘플상품-07/42/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=ptlist.get(1).getP_name()%></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=ptlist.get(1).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>
...
<span>BEST</span><span class="num">02</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=ptlist.get(3).getP_no()%>&p_name=<%=ptlist.get(3).getP_name()%>&p_price=<%=ptlist.get(3).getP_price()%>&p_imgsrc=<%=ptlist.get(3).getP_imgsrc()%>&p_kinds=<%=ptlist.get(3).getP_kinds()%>" name="anchorBoxName_41"><img src="<%=request.getContextPath()%>/web/images/200_light/220_ptlight/ptlight3.jpg" id="eListPrdImage41_2" alt="sample product 06"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-06/41/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=ptlist.get(3).getP_name()%></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=ptlist.get(3).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>
...
<span>BEST</span><span class="num">03</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=ptlist.get(5).getP_no()%>&p_name=<%=ptlist.get(5).getP_name()%>&p_price=<%=ptlist.get(5).getP_price()%>&p_imgsrc=<%=ptlist.get(5).getP_imgsrc()%>&p_kinds=<%=ptlist.get(5).getP_kinds()%>" name="anchorBoxName_40"><img src="<%=request.getContextPath()%>/web/images/200_light/220_ptlight/ptlight5.jpg" id="eListPrdImage40_2" alt="sample product 05"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
...
<span>BEST</span><span class="num">04</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=ptlist.get(7).getP_no()%>&p_name=<%=ptlist.get(7).getP_name()%>&p_price=<%=ptlist.get(7).getP_price()%>&p_imgsrc=<%=ptlist.get(7).getP_imgsrc()%>&p_kinds=<%=ptlist.get(7).getP_kinds()%>" name="anchorBoxName_39"><img src="<%=request.getContextPath()%>/web/images/200_light/220_ptlight/ptlight7.jpg" id="eListPrdImage39_2" alt="sample product 04"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-04/39/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=ptlist.get(7).getP_name()%></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=ptlist.get(7).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>   
...
<li id="anchorBoxId_42" class="xans-record-">
            <div class="thumbnail">
                <div class="prdImg" id="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=ptlist.get(i).getP_no()%>&p_name=<%=ptlist.get(i).getP_name()%>&p_price=<%=ptlist.get(i).getP_price()%>&p_imgsrc=<%=ptlist.get(i).getP_imgsrc()%>&p_kinds=<%=ptlist.get(i).getP_kinds()%>" name="anchorBoxName_42"><img src="<%=request.getContextPath()%>/web/images/200_light/220_ptlight/<%=ptlist.get(i).getP_imgsrc()%>"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <span class="chk"></span>
                <strong class="name"><a href="<%=request.getContextPath()%>/product/샘플상품-07/42/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=ptlist.get(i).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=ptlist.get(i).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>
<%} %>
