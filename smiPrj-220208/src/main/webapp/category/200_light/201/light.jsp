...
<h2><span><strong style="font-size: 25px;">인테리어 조명</strong></span></h2>
...
<span>BEST</span><span class="num">02</span>
            ...
            <div class="description">
                ...
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=lilist.get(3).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>
<li id="anchorBoxId_41" class="xans-record-">
...
<span>BEST</span><span class="num">02</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=ptlist.get(1).getP_no()%>&p_name=<%=ptlist.get(1).getP_name()%>&p_price=<%=ptlist.get(1).getP_price()%>&p_imgsrc=<%=ptlist.get(1).getP_imgsrc()%>&p_kinds=<%=ptlist.get(1).getP_kinds()%>" name="anchorBoxName_41"><img src="/semiPrj-orgin/web/images/200_light/220_ptlight/ptlight1.jpg" id="eListPrdImage41_2" alt="sample product 06"></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
