...
<h2><span><strong style="font-size: 25px;">홈 갤러리</strong></span></h2>
...
<span>BEST</span><span class="num">01</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=homelist.get(1).getP_no() %>&p_name=<%=homelist.get(1).getP_name()%>&p_price=<%=homelist.get(1).getP_price()%>&p_imgsrc=<%=homelist.get(1).getP_imgsrc()%>&p_kinds=<%=homelist.get(1).getP_kinds()%>" name="anchorBoxName_42"><img src="<%=request.getContextPath()%>/web/images/100_homedeco/130_Homegallery/HG1.JPG" id="eListPrdImage42_2" alt="샘플상품 07"/></a>
...
<span>BEST</span><span class="num">02</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=homelist.get(3).getP_no() %>&p_name=<%=homelist.get(3).getP_name()%>&p_price=<%=homelist.get(3).getP_price()%>&p_imgsrc=<%=homelist.get(3).getP_imgsrc()%>&p_kinds=<%=homelist.get(3).getP_kinds()%>" name="anchorBoxName_41"><img src="<%=request.getContextPath()%>/web/images/100_homedeco/130_Homegallery/HG3.JPG" id="eListPrdImage41_2" alt="sample product 06"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-06/41/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=homelist.get(3).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=homelist.get(3).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>
...
<span>BEST</span><span class="num">03</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=homelist.get(5).getP_no() %>&p_name=<%=homelist.get(5).getP_name()%>&p_price=<%=homelist.get(5).getP_price()%>&p_imgsrc=<%=homelist.get(5).getP_imgsrc()%>&p_kinds=<%=homelist.get(5).getP_kinds()%>" name="anchorBoxName_40"><img src="<%=request.getContextPath()%>/web/images/100_homedeco/130_Homegallery/HG5.JPG" id="eListPrdImage40_2" alt="sample product 05"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-05/40/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=homelist.get(5).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=homelist.get(5).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>          
...
<span>BEST</span><span class="num">04</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=homelist.get(7).getP_no() %>&p_name=<%=homelist.get(7).getP_name()%>&p_price=<%=homelist.get(7).getP_price()%>&p_imgsrc=<%=homelist.get(7).getP_imgsrc()%>&p_kinds=<%=homelist.get(7).getP_kinds()%>" name="anchorBoxName_39"><img src="<%=request.getContextPath()%>/web/images/100_homedeco/130_Homegallery/HG7.JPG" id="eListPrdImage39_2" alt="sample product 04"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-04/39/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=homelist.get(7).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=homelist.get(7).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>   
...
<div class="function" id="Product_ListMenu">
            <p class="prdCount" style="font-size: 15px;">Total : <strong style="font-size: 15px;"><%=totcount3%></strong> items</p>
...
<li id="anchorBoxId_42" class="xans-record-">
            <div class="thumbnail">
                <div class="prdImg" id="prdImg">
                    <!--  <a href="<%=request.getContextPath()%>/product_detail/100_homedeco/110_basketbox/basket_product01/product_detail01.jsp?p_no=<%=homelist.get(i).getP_no()%>&p_name=<%=homelist.get(i).getP_name()%>&p_price=<%=homelist.get(i).getP_price()%>&p_imgsrc=<%=homelist.get(i).getP_imgsrc()%>&p_kinds=<%=homelist.get(i).getP_kinds()%>" name="anchorBoxName_42"><img src="<%=request.getContextPath()%>/web/images/100_homedeco/130_Homegallery/<%=homelist.get(i).getP_imgsrc()%>"/></a>-->
                    <a href="<%=request.getContextPath()%>/product_detail/100_homedeco/110_basketbox/basket_product01/product_detail01.jsp?p_no=<%=homelist.get(i).getP_no()%>&p_name=<%=homelist.get(i).getP_name()%>&p_price=<%=homelist.get(i).getP_price()%>&p_imgsrc=<%=homelist.get(i).getP_imgsrc()%>&p_kinds=<%=homelist.get(i).getP_kinds()%>" name="anchorBoxName_42"><img src="<%=request.getContextPath()%>/web/images/<%=homelist.get(i).getP_kinds() %>/<%=homelist.get(i).getP_imgsrc()%>"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <span class="chk"></span>
                <strong class="name"><a href="<%=request.getContextPath()%>/product/샘플상품-07/42/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" decolist=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=homelist.get(i).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
...
<li class="xans-record-"><a href="<%=request.getContextPath()%>/category/100_homedeco/101/homedeco.jsp?page=1" class="this">1</a></li>
        <li class="xans-record-"><a href="<%=request.getContextPath()%>/category/100_homedeco/101/homedeco.jsp?page=2" class="other">2</a></li>
            </ol>
