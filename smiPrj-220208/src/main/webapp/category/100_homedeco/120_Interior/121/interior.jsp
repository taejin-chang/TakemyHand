...
<h2><span><strong style="font-size: 25px;">인테리어 소품</strong></span></h2>
...
<span>BEST</span><span class="num">01</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=decolist.get(1).getP_no()%>&p_name=<%=decolist.get(1).getP_name()%>&p_price=<%=decolist.get(1).getP_price()%>&p_imgsrc=<%=decolist.get(1).getP_imgsrc()%>&p_kinds=<%=decolist.get(1).getP_kinds()%>" name="anchorBoxName_42"><img src="<%=request.getContextPath()%>/web/images/100_homedeco/120_interior/DECO1.JPG" id="eListPrdImage42_2" alt="샘플상품 07"/></a>
...
<span>BEST</span><span class="num">02</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=decolist.get(3).getP_no()%>&p_name=<%=decolist.get(3).getP_name()%>&p_price=<%=decolist.get(3).getP_price()%>&p_imgsrc=<%=decolist.get(3).getP_imgsrc()%>&p_kinds=<%=decolist.get(3).getP_kinds()%>" name="anchorBoxName_41"><img src="<%=request.getContextPath()%>/web/images/100_homedeco/120_interior/DECO3.JPG" id="eListPrdImage41_2" alt="sample product 06"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-06/41/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=decolist.get(3).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=decolist.get(3).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>
...
<span>BEST</span><span class="num">03</span>
            ...
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-05/40/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=decolist.get(5).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=decolist.get(5).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>          
...
<span>BEST</span><span class="num">04</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/product_detail01.jsp?p_no=<%=decolist.get(7).getP_no()%>&p_name=<%=decolist.get(7).getP_name()%>&p_price=<%=decolist.get(7).getP_price()%>&p_imgsrc=<%=decolist.get(7).getP_imgsrc()%>&p_kinds=<%=decolist.get(7).getP_kinds()%>" name="anchorBoxName_39"><img src="<%=request.getContextPath()%>/web/images/100_homedeco/120_interior/DECO7.JPG" id="eListPrdImage39_2" alt="sample product 04"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/sample-product-04/39/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=decolist.get(7).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
<strong class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span> :</strong> <span style="font-size:11px;color:#555555;"><%=decolist.get(7).getP_price()%>원</span><span id="span_product_tax_type_text" style=""> </span></li>
</ul>
</div>
        </li>   
...
<li id="anchorBoxId_42" class="xans-record-">
            ...
            <div class="description">
                ...
                <span class="chk"></span>
                <strong class="name"><a href="<%=request.getContextPath()%>/product/샘플상품-07/42/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" decolist=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;"><%=decolist.get(i).getP_name() %></span></a></strong>
                <ul class="xans-element- xans-product xans-product-listitem spec"><li class=" xans-record-">
