        ...
        <div class="xans-element- xans-product xans-product-image imgArea "><div class="keyImg">
                <div class="thumbnail">
                    <%if(p_kinds.equals("110")){ %>  
                       <img src="<%=request.getContextPath()%>/web/images/100_homedeco/110_DLY/<%=p_imgsrc%>" class="BigImage "/>
                    <%}else if(p_kinds.equals("120")){%>
                       <img src="<%=request.getContextPath()%>/web/images/100_homedeco/120_interior/<%=p_imgsrc%>" class="BigImage "/>
                    ...
                    <%}else if(p_kinds.equals("210")){%>
                    <img src="<%=request.getContextPath()%>/web/images/200_light/210_light/<%=p_imgsrc%>"  class="BigImage" alt="" />
                    <%}else if(p_kinds.equals("220")){%>
                    <img src="<%=request.getContextPath()%>/web/images/200_light/220_ptlight/<%=p_imgsrc%>"  class="BigImage" alt="" />
                    <%}else if(p_kinds.equals("310")){%>
                    <img src="<%=request.getContextPath()%>/web/images/300_organize/310_bookshelf/<%=p_imgsrc%>"  class="BigImage" alt="" />
                    <%}else if(p_kinds.equals("320")){%>
                    <img src="<%=request.getContextPath()%>/web/images/300_organize/320_drawer/<%=p_imgsrc%>"  class="BigImage" alt="" />
                    <%}else if(p_kinds.equals("400")){%>
                    <img src="<%=request.getContextPath()%>/web/images/400_furniture/<%=p_imgsrc%>"  class="BigImage" alt="" />
                    <%}%>
...
<%}else if(p_kinds.equals("210")){%>
<img src="<%=request.getContextPath()%>/web/images/200_light/210_light/<%=p_imgsrc%>"  class="ThumbImage"/>
<%}else if(p_kinds.equals("220")){%>
<img src="<%=request.getContextPath()%>/web/images/200_light/220_ptlight/<%=p_imgsrc%>"  class="ThumbImage"/>
<%}else if(p_kinds.equals("310")){%>
<img src="<%=request.getContextPath()%>/web/images/300_organize/310_bookshelf/<%=p_imgsrc%>"  class="ThumbImage"/>
<%}else if(p_kinds.equals("320")){%>
<img src="<%=request.getContextPath()%>/web/images/300_organize/320_drawer/<%=p_imgsrc%>"  class="ThumbImage"/>
<%}else if(p_kinds.equals("400")){%>
<img src="<%=request.getContextPath()%>/web/images/400_furniture/<%=p_imgsrc%>"  class="ThumbImage"/>
<%} %>
</li>
                                    </ul>
</div>
...
<td><%=p_name%></td>
                            <td>
                                <span class="quantity">
                                    ...
                                    <input name="quantity2" id="quantity2" value="1" type="text"/> <a href="javascript:add();" class="up QuantityUp"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/product/btn_count_up.gif" alt="수량증가"/></a>
...
<tbody></tbody>
            ...
            <div class="xans-element- xans-product xans-product-action "><div class="ec-base-button gColumn">
                    <a href="javascript:send();" class="btnSubmit sizeL " onclick="send2();">
