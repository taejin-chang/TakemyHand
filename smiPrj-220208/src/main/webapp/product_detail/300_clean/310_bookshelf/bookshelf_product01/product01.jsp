...
(function(i, s, o, g, r, a, m) {
    ...
    a.src = g;
    a.onload = function() {
        i[r].init('https://js-error-tracer-api.cafe24.com', {"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..QGUG4S01Q_C5pyhQaaGrkV6Rt5GraBVQjxltNxuyD2k","collectWindowErrors":true,"preventDuplicateReport":true,"storageKeyPrefix":"EC_JET.PRODUCT_DETAIL"});
    };
...
<meta property="og:url" content="http://ecudemo200642.cafe24.com/product/sample-product-01/11/" />
<meta property="og:title" content="sample product 01" />
<meta property="og:site_name" content="쇼핑몰 이름" />
<meta property="og:type" content="product" />
<meta property="og:image" content="http://ecudemo200642.cafe24.com/web/product/big/202110/40af57294030f1fbd1272c40c8d1ab8b.jpg" />
<meta property="product:price:amount" content="14000" />
<meta property="product:price:currency" content="KRW" />
<meta property="product:sale_price:amount" content="14000" />
<meta property="product:sale_price:currency" content="KRW" />
<meta property="product:productId" content="11" />
...
CAFE24.FRONT_JS_CONFIG_SHOP = {"bDirectBuyOrderForm":false,"bECUseItemSalePrice":false,"sCouponDownloadPage":"\/coupon\/coupon_productdetail.html","aOptionColorchip":{"#000000":"","#FFFFFF":""}};
...
<li><a href="../../../../index.html">홈</a></li>
        <li class=""><a href="../../../../category/sale/51/index.html">SALE</a></li>
...
<div class="detailArea ">
        <div class="xans-element- xans-product xans-product-image imgArea "><div class="keyImg">
                <div class="thumbnail">
                    <a href="http://ecudemo200642.cafe24.com/product/image_zoom2.html?product_no=11&cate_no=1&display_group=2" alt="P000000L" onclick="window.open(this.href, 'image_zoom2', 'toolbar=no,scrollbars=auto,resizable=yes,width=450,height=693,left=0,top=0', this);return false;">
                        <img src="//ecudemo200642.cafe24.com/web/product/big/202110/40af57294030f1fbd1272c40c8d1ab8b.jpg" alt="sample product 01" class="BigImage "/>                    </a>
                    <div id="zoom_wrap"></div>
                </div>
            </div>
<div class="xans-element- xans-product xans-product-addimage listImg"><ul>
<li class="xans-record-"><img src="//ecudemo200642.cafe24.com/web/product/small/202110/95f7516e53df8301fa17ffe8f7401280.jpg"  class="ThumbImage" alt="" /></li>
                                    </ul>
</div>
<!--div class="control">
                <a href="http://ecudemo200642.cafe24.com/product/image_zoom2.html?product_no=11&cate_no=1&display_group=2" class="btnZoom" onclick="window.open(this.href, 'image_zoom2', 'toolbar=no,scrollbars=auto,resizable=yes,width=560,height=710,left=0,top=0', this);return false;"><img src="//img.echosting.cafe24.com/skin/base/common/btn_icon_zoom.gif" alt="" /> 확대보기</a>
            </div-->
<!--div class="color ">
...
<!--div class="ec-base-button gColumn" module="product_action">
                <a href="#none" class="btnNormal sizeM" onclick="">추천메일 보내기</a>
                <a href="#none" class="btnNormal sizeM displaynone" onclick="">상품조르기</a>
                <a href="../../../../../../../board/inquiry/write.html" class="btnNormal sizeM displaynone">대량구매문의</a>
            </div-->
...
<!--[]-->sample product 01 </h2>
                ...
                <div class="supply displaynone">
                    <span></span>
                    <a href="#none" onclick=""><img src="<%=request.getContextPath()%>/2" alt="공급사 바로가기"/></a>
                </div>
                <!-- //공급사 바로가기버튼 영역 -->
            </div>            
...
<th scope="row"><span style="font-size:16px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span></th>
                            <td><span style="font-size:16px;color:#555555;">sample product 01</span></td>
                        </tr>
...
<th scope="row"><span style="font-size:12px;color:#000000;font-weight:bold;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_PRICE>판매가</span></th>
                            <td><span style="font-size:12px;color:#000000;font-weight:bold;"><strong id="span_product_price_text">14,000원 </strong><input id="product_price" name="product_price" value="" type="hidden"  /></span></td>
                        </tr>
<tr class=" xans-record-">
<th scope="row"><span style="font-size:12px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_DELIVERY_TITLE>국내·해외배송</span></th>
...
<th scope="row"><span style="font-size:12px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_DELIVERY_PRICE>배송비</span></th>
                            <td><span style="font-size:12px;color:#555555;"><span class="delv_price_B"><input id="delivery_cost_prepaid" name="delivery_cost_prepaid" value="P" type="hidden"  /><strong>2,500원</strong> (50,000원 이상 구매 시 무료)</span></span></td>
                        </tr>
</tbody>
</table>
</div>
...
<th scope="row">구매방법</th>
                    ...
                    <label class="gLabel"> 정기배송<span class="badge displaynone"> <i class="icoDown">할인</i></span></label>
                            </td>
                        </tr>
...
<th scope="row">배송주기</th>
                            <td>
                                ...
                                <div class="info displaynone" id="">
                                    <p class="title"><strong>정기배송 할인</strong> <span class="icoSave">save</span></p>
                                    <ul class="xans-element- xans-product xans-product-regulardiscount"><li class=""> 결제 시 :  <span class="icoDown">할인</span>
</li>
</ul>
</div>
                            </td>
...
<th scope="row">COLOR</th>
                        <td><ul  option_product_no="11" option_select_element="ec-option-select-finder" option_sort_no="1" option_type="T" item_listing_type="S" option_title="COLOR" product_type="product_option" product_option_area="product_option_11_0" option_style="radio" ec-dev-id="product_option_id1" ec-dev-name="option1" ec-dev-class="ProductOption0" class="ec-product-radio" required="true" ><li class="" option_value="블랙" link_image="" title="블랙"><label><input type="radio" name="product_option_id1">블랙</label></li><li class="" option_value="화이트" link_image="" title="화이트"><label><input type="radio" name="product_option_id1">화이트</label></li></ul><p class="value">[필수] <span class="ec-shop-front-product-option-desc-trigger" data-option_msg="옵션을 선택해 주세요">옵션을 선택해 주세요</span></p>
</td>
                    </tr></tbody>
<tbody></tbody>
<tbody>
...
<div class="guideArea">
                ...
                <span class="sizeGuide displaynone"><a href="#none" class="size_guide_info" product_no="11">사이즈 가이드</a></span>
            </div>
...
<td>sample product 01</td>
                            <td>
                                <span class="quantity">
                                    <input id="quantity" name="quantity_name" style="" value="0" type="text"  />                                    <a href="javascript:;" class="up QuantityUp"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/product/btn_count_up.gif" alt="수량증가"/></a>
                                    <a href="javascript:;" class="down QuantityDown"><img src="//img.echosting.cafe24.com/skin/base_ko_KR/product/btn_count_down.gif" alt="수량감소"/></a>
                                </span>
                            </td>
                            <td class="right">
<span class="quantity_price">14000</span> <span class="mileage displaynone">(<img src="../2"/>  <span class="mileage_price"></span>)</span>
</td>
...
<!-- // 옵션선택 또는 세트상품 선택시 상품이 추가되는 영역입니다. 쇼핑몰 화면에는 아래와 같은 마크업구조로 표시됩니다. 삭제시 기능이 정상동작 하지 않습니다. -->
            ...
            <div class="xans-element- xans-product xans-product-action "><div class="ec-base-button gColumn">
                    <a href="#none" class="btnSubmit sizeL " onclick="product_submit(1, '/exec/front/order/basket/', this)">
                        <span id="btnBuy">BUY NOW</span>
                        <span id="btnReserve" class="displaynone">예약주문</span>
                        <span id="" class="displaynone">정기배송 신청하기</span>
                    </a>
                    <a href="#none" class="btnNormal sizeL " onclick="product_submit(2, '/exec/front/order/basket/', this)">CART</a>
                    <span class="btnEm sizeL gFlex2 displaynone">SOLD OUT</span>
                    <a href="#none" onclick="add_wishlist_nologin('/member/login.html');" class="btnNormal sizeL ">WISH LIST</a>
                </div>
<!-- 네이버 체크아웃 구매 버튼 -->
...
<div class="board">
            ...
            <p class="ec-base-button typeBorder">
                <span class="gRight">
                    <a href="http://ecudemo200642.cafe24.com/board/product/write.html?board_no=4&product_no=11&cate_no=1&display_group=2" class="btnNormal">상품후기쓰기</a>
                    <a href="http://ecudemo200642.cafe24.com/board/product/list.html?board_no=4&link_product_no=11" class="btnNormal">모두 보기</a>
                </span>
            </p>
...
<div class="board">
            ...
            <p class="ec-base-button typeBorder">
                <span class="gRight">
                    <a href="http://ecudemo200642.cafe24.com/board/product/write.html?board_no=6&product_no=11&cate_no=1&display_group=2" class="btnNormal">상품문의하기</a>
                    <a href="http://ecudemo200642.cafe24.com/board/product/list.html?board_no=6&link_product_no=11" class="btnNormal">모두 보기</a>
                </span>
            </p>
