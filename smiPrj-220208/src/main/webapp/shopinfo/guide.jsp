...
(function(i, s, o, g, r, a, m) {
    ...
    a.src = g;
    a.onload = function() {
        i[r].init('https://js-error-tracer-api.cafe24.com', {"token":"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..rU8qHVUHEaCOlczmnfSDsEtH6F0nIsy88-KMOWIC1fk","collectWindowErrors":true,"preventDuplicateReport":true,"storageKeyPrefix":"EC_JET.SHOPINFO_FAQ"});
    };
...
<link rel="stylesheet" type="text/css" href="http://ecudemo200642.cafe24.com/ind-script/optimizer.php?filename=nc1LCoAwDIThfXHrOYLeqC3xAU2mpCno7RW8gHQ7zMdPB4RpWY2qYbcoZNzQLTPl1mgzqFOGCHR6h5n-_DmHhtL9hIaEaxB299FoiTfbGPWYCg9S1FBO5ZCi6td_AA&type=css&k=37c9481ac0212340e132f81eba4d1049fee7f18e&t=1635315871"  /><link rel="stylesheet" type="text/css" href="http://ecudemo200642.cafe24.com/ind-script/optimizer.php?filename=tdTBTgQhDAbg-45Xn6ObjfEZPHjzCZjSgSZAcQob9-1lVmM8K70RIF_Jn1KIkgkIl66061h0T1ku5_Pz0wVqXxPjEltOoJ4WT8qhwOqUAFUhi--JILuUYHPvD2PvEf4KJneT3o41411HyVnKZPRrYzJKeDoOTp2N4CaSGlcjPVKyous-WgSt8q4ucHGNrFJ3q5G89tamt_YPLh92gSSrsMclNKLHAe3_s39Nu-8yuY8fqVHqW-RauYTZBVDKdRgspeJ0e3yaIPtttqvkdowv5Pz8wJMEaVKnP7mNLA5728zoYtZ8r6z34foJ&type=css&k=e72d39563ab15341bb427df6fe87b82acc54b037&t=1636193578&user=T"  />
...
<div class="path">
    ...
    <ol><li><a href="../index.html">홈</a></li>
        <li title="현재 위치"><strong>이용안내</strong></li>
    </ol></div>
...
<div class="xans-element- xans-mall xans-mall-faq "><div id="member" class="ec-base-tab grid7">
        <ul class="menu">
...
<div class="cont">
            <h3>회원가입 안내</h3>
            <div class="fr-view fr-view-faq-member-info">[회원가입] 메뉴를 통해 이용약관, 개인정보보호정책 동의 및 일정 양식의 가입항목을 기입함으로써 회원에
...
<div class="cont">
            <h3>결제안내</h3>
            <div class="fr-view fr-view-faq-payment-info">고액결제의 경우 안전을 위해 카드사에서 확인전화를 드릴 수도 있습니다. 확인과정에서 도난 카드의 사용이나 타인 명의의 주문등
...
<li>배송 방법 : 택배</li>
                <li>배송 지역 : 전국지역</li>
                <li>배송 비용 : 조건부 무료 : 주문 금액 50,000원 미만일 때 배송비 2,500원을 추가합니다.</li>
                <li>배송 기간 : 3일 ~ 7일</li>
...
<div class="cont">
            <h3>교환/반품안내</h3>
            <div class="fr-view fr-view-faq-prod-change-agreement"><b>교환 및 반품 주소</b><br/>-  <b><br/><br/>교환 및 반품이 가능한 경우</b><br>
