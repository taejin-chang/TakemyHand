...
<div class="titleArea">
 <%if(ref.equals("0")) { %>
            <h2><font color="333333">자유게시판</font></h2>
            <p>자유게시판입니다.</p>
            <% } else { %>
...
<form id="boardWriteForm" name="board" action="<%=request.getContextPath() %>/board/freeboard/board_write_action.jsp?m_userid=<%=loginMember.getM_userid()%>" method="post"  enctype="multipart/form-data">
...
<td colspan="2" class="clear">
            ...
            <!-- HTML-->
            <textarea style="width: 100%;" name="rcontent" id="content" class="ec-fr-never-be-duplicated"></textarea>
...
<div class="ec-base-button ">
            ...
            <span class="gRight">
              <!-- <a href="<%=request.getContextPath() %>/board/review/review_write_action.jsp" class="btnSubmitFix sizeS" onclick="send();">등록</a>  -->
                <button type="submit" id="insertBtn" style="background-color: black; color: white; width: 96px; height: 32px">등록</button>
              <!-- <a href="javascript:history.back();" class="btnBasicFix sizeS">취소</a> -->
            	<button type="button" onclick="history.back();" style="background-color:silver; color: black; width: 96px; height: 32px">취소</button>
            </span>
        </div>
</div>
