...
<form id="boardWriteForm" name="boardWriteForm" action="<%=request.getContextPath()%>/board/qa/qa_add_action.jsp?m_userid=<%=loginMember.getM_userid() %>" method="post" target="_self">
...
<th scope="row">제목</th>
                    <td> 
<input id="q_title" name="q_title" fw-filter="isFill" fw-label="제목" fw-msg="" class="inputTypeText"  maxLength="125" type="text"  /></div>
</td>
                </tr>
<tr class="display">
<th scope="row">작성자</th>
...
<div class="ec-base-button ">
            ...
            <span class="gRight">
                <button id="insertBtn" type="submit" class="btnSubmitFix sizeS">등록</button>
