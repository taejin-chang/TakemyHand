...
<div class="titleArea">
 <%if(ref.equals("0")) { %>
            <h2><font color="333333">상품 사용후기</font></h2>
            <p>상품사용후기입니다.</p>
            <% } else { %>
            <h2><font color="333333">상품 사용후기 답글</font></h2>
            <p>상품사용후기답글입니다.</p>
            <% } %>
        </div>
</div>

<form id="reviewWriteForm" name="review" action="<%=request.getContextPath() %>/board/review/review_write_action.jsp?m_userid=<%=loginMember.getM_userid()%>" method="post"  enctype="multipart/form-data">
