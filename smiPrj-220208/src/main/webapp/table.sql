create table member (
	...
	m_passwd varchar2(2000) not null,		-- 비밀번호
	m_zipcode varchar2(40) not null,		-- 우편번호
	...
	m_grade number(1) default 1,         --등급  0:탈퇴 1:일반 9:관리자 
...
create table product (
	...
	p_kinds varchar2(20) not null,		-- 상품분류
...
create table orders (
	...
	o_amount number(5) not null,	-- 주문 수량
...
create table board (
	...
	b_status number default 0 not null, --상태  (0 : 일반글, 1 : 비밀글) 
...
create table DLY (
	p_no varchar2(20) not null ,	-- 상품 번호  
	p_name varchar2(100) not null,		-- 상품명
	p_kinds varchar2(20) not null,		-- 상품분류:110
	p_price number(20) not null, 	    -- 상품가격
	p_amount number(20) not null,        -- 상품 수량
	p_imgsrc varchar2(2000) ,        -- 상품 이미지 파일명
	primary key(p_no)			-- 기본키 : 상품번호 
...
create table DECO (
	p_no varchar2(20) not null ,	-- 상품 번호  
	p_name varchar2(100) not null,		-- 상품명
	p_kinds varchar2(20) not null,		-- 상품분류:120
	p_price number(20) not null, 	    -- 상품가격
	p_amount number(20) not null,        -- 상품 수량
	p_imgsrc varchar2(2000) ,        -- 상품 이미지 파일명
	primary key(p_no)			-- 기본키 : 상품번호 
...
create table HOMEGALLERY (
	p_no varchar2(20) not null ,	-- 상품 번호  
	p_name varchar2(100) not null,		-- 상품명
	p_kinds varchar2(20) not null,		-- 상품분류:130
	p_price number(20) not null, 	    -- 상품가격
	p_amount number(20) not null,        -- 상품 수량
	p_imgsrc varchar2(2000) ,        -- 상품 이미지 파일명
	primary key(p_no)			-- 기본키 : 상품번호 
